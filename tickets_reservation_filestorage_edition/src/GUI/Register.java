...
public class Register extends javax.swing.JFrame {
    ...
    static private void checkAdmin(String[] x) throws CustomException3 {
        if (x[0].equals("true")) {
            isAdmin = "true";
        } else if (x[0].equals("false")) {
            isAdmin = "false";
        } else {
            throw new CustomException3("invalid Authentication!");
        }
    }
